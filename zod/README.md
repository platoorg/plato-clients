...
```bash
npm install @platoorg/zod-client
```
...
```bash
npx plato-zod src/lib/schemas/plato-manifest.json
```

**Custom manifest path and custom output path**:

```bash
npx plato-zod src/lib/schemas/plato-manifest.json src/lib/plato/generated.ts
```
