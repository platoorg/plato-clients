...
| Go           | `go/`          | `go build -o plato-client` · `./plato-client`                      |
| Rust         | `rust/`        | `cargo build --release` · `./target/release/plato-client`          |
| Ruby         | `ruby/`        | `gem build` · `ruby exe/plato-client`                              |
...
plato-manifest.json  ──▶  plato-client    ──▶  plato-client.go   (go)
plato-manifest.json  ──▶  plato-client    ──▶  plato_client.rs   (rust)
plato-manifest.json  ──▶  plato-client    ──▶  plato_client.rb   (ruby)
