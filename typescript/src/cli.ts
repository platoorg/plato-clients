#!/usr/bin/env node
/**
 * plato-ts -- generate a typed client from a plato-manifest.json
 *
 * Usage:
 *   plato-ts [manifest] [output] [--lang=typescript]
 *
 * Defaults:
 ...
 * Examples:
 *   plato-ts
 *   plato-ts src/lib/schemas/plato-manifest.json src/lib/plato/generated.ts
 *   plato-ts path/to/plato-manifest.json --lang=typescript
 */
